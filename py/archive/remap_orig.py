...
#	f.createDimension('nq', len(nq))
	...
	theta_rhodz.setncattr("coordinates", "presnivs lon lat")

        ulon = f.createVariable('ulon', 'd', ('lev','cell'))
	ulon.setncattr("coordinates", "presnivs lon lat")

        ulat = f.createVariable('ulat', 'd', ('lev','cell'))
	ulat.setncattr("coordinates", "presnivs lon lat")

#        q = f.createVariable('q', 'd', ('nq','lev','cell'))
#	q.setncattr("coordinates", "nq presnivs lon lat")
